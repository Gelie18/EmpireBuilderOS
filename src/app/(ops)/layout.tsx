...
import SideNavOps from '@/components/ops/SideNavOps';
        ...
        <div className="h-dvh flex flex-col overflow-x-hidden" style={{ background: 'var(--color-bg)' }}>
          ...
          <div className="flex flex-1 min-h-0 overflow-hidden">
            ...
            <main className="flex-1 min-w-0 overflow-y-auto overscroll-contain">
              <div className="w-full px-4 pt-4 md:px-6 md:pt-5 md:pb-8 flex flex-col gap-4 md:gap-5" style={{ maxWidth: 1400, margin: '0 auto' }}>
                {children}
