            ...
            {filtered.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {isOpen && (
                    <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', background: '#242840', padding: '16px 20px 20px' }}>
                      {item.blockers && (
                        <div style={{
                          ...
                          <span style={{ fontSize: 13, color: '#D97706' }}>{item.blockers}</span>
                        </div>
                      )}
              ...
              {CATEGORIES.map((cat) => {
                ...
                return (
                  <div key={cat}
                    ...
                    style={{
                      padding: '14px 16px', background: '#242840', borderRadius: 8,
