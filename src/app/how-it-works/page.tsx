...
const INTEGRATIONS = [
  { category: 'Accounting / ERP', color: '#1B4DE6', tools: ['QuickBooks', 'NetSuite', 'Sage Intacct', 'Xero', 'Microsoft Dynamics', 'Oracle NetLedger'] },
  { category: 'HRIS / Payroll', color: '#0A8A5C', tools: ['Rippling', 'Gusto', 'Workday', 'BambooHR', 'ADP', 'Paychex', 'Justworks'] },
  { category: 'Commerce', color: '#F58A1F', tools: ['Shopify', 'BigCommerce', 'WooCommerce', 'Amazon Seller Central', 'Faire', 'Square', 'Etsy'] },
  ...
  { category: 'Ops / CRM / Data', color: '#1B4DE6', tools: ['Shopify Flow', 'HubSpot', 'Salesforce', 'Notion', 'Slack', 'Airtable', 'Google Workspace', 'Microsoft 365'] },
];
      ...
      <div style={{ background: '#0B0D17', color: '#FFFFFF', fontFamily: '"DM Sans", system-ui, sans-serif', overflowX: 'hidden' }}>
        ...
        <section className="hiw-hero" style={{ padding: '96px 40px 80px', maxWidth: 1100, margin: '0 auto', animation: 'fadeUp 0.7s ease both' }}>
          ...
          <h1 className="hero-h1" style={{ fontSize: 72, fontWeight: 900, lineHeight: 1.02, letterSpacing: '-0.03em', maxWidth: 900, marginBottom: 32 }}>
            ...
            <span style={{ color: '#1B4DE6' }}>every single week.</span>
          </h1>
          ...
          <div style={{ display: 'flex', gap: 14, flexWrap: 'wrap' }}>
            <button onClick={() => router.push('/packages')} style={{ padding: '16px 36px', background: '#F58A1F', color: '#0B0D17', border: 'none', borderRadius: 9, fontSize: 14, fontWeight: 800, letterSpacing: '0.08em', textTransform: 'uppercase', cursor: 'pointer', fontFamily: 'inherit' }}>
              See Packages
            </button>
        ...
        {/* ── STATS BAR ── */}
        <section style={{ background: '#1B4DE6', padding: '0' }}>
          <div className="stat-grid" style={{ maxWidth: 1100, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(3,1fr)' }}>
            {[
              ...
              <div key={s.val} className="hiw-stat-cell" style={{ padding: '56px 48px', borderRight: i < 2 ? '1px solid rgba(255,255,255,0.15)' : 'none', textAlign: 'center' }}>
                ...
                <div style={{ fontSize: 16, fontWeight: 800, color: '#F58A1F', marginTop: 10, textTransform: 'uppercase', letterSpacing: '0.12em' }}>{s.label}</div>
        ...
        <section className="hiw-section" style={{ background: '#FFFFFF', padding: '96px 40px' }}>
          <div className="two-col" style={{ maxWidth: 1100, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center' }}>
            <div>
              <div style={{ fontSize: 12, fontWeight: 800, letterSpacing: '0.20em', textTransform: 'uppercase', color: '#1B4DE6', marginBottom: 20 }}>What We Build</div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              {[
                ...
                <div key={text} style={{ display: 'flex', alignItems: 'center', gap: 16, padding: '16px 20px', background: '#F4F6FF', border: '1px solid #E0E6FF', borderRadius: 10 }}>
                  <div style={{ width: 8, height: 8, borderRadius: '50%', background: '#1B4DE6', flexShrink: 0 }} />
        ...
        <section className="hiw-section" style={{ background: '#0B0D17', padding: '96px 40px' }}>
          <div style={{ maxWidth: 1100, margin: '0 auto' }}>
            <div style={{ marginBottom: 64 }}>
              <div style={{ fontSize: 12, fontWeight: 800, letterSpacing: '0.20em', textTransform: 'uppercase', color: '#F58A1F', marginBottom: 18 }}>The Engagement Model</div>
              <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', flexWrap: 'wrap', gap: 16 }}>
                <h2 className="hiw-h2-lg" style={{ fontSize: 56, fontWeight: 900, color: '#FFFFFF', lineHeight: 1.05, letterSpacing: '-0.025em' }}>
                  A 90-day build.<br />
                  <span style={{ color: '#F58A1F' }}>Guaranteed live.</span>
                </h2>
                <div style={{ padding: '16px 24px', background: 'rgba(245,138,31,0.10)', border: '1px solid rgba(245,138,31,0.30)', borderRadius: 10 }}>
                  ...
                  <div style={{ fontSize: 16, fontWeight: 700, color: '#F58A1F' }}>25% fee credit if not live by Day 90</div>
                </div>
              </div>
            </div>
            ...
            <div className="phase-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 2 }}>
              {PHASES.map((phase, i) => (
                <div key={phase.num} style={{
                  background: i === 2 ? '#F58A1F' : i === 1 ? '#1B4DE6' : '#0F1120',
                  padding: '52px 44px',
                  ...
                  <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: '0.10em', textTransform: 'uppercase', color: i === 2 ? '#0B0D17' : '#F58A1F', marginBottom: 18 }}>{phase.weeks}</div>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                    {phase.items.map((item) => (
                      <div key={item} style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                        <div style={{ width: 6, height: 6, borderRadius: '50%', background: i === 2 ? '#0B0D17' : '#F58A1F', flexShrink: 0 }} />
        ...
        <section className="hiw-section" style={{ background: '#F4F6FF', padding: '96px 40px' }}>
          <div style={{ maxWidth: 1100, margin: '0 auto' }}>
            <div style={{ marginBottom: 52 }}>
              <div style={{ fontSize: 12, fontWeight: 800, letterSpacing: '0.20em', textTransform: 'uppercase', color: '#1B4DE6', marginBottom: 16 }}>What Gets Automated</div>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12 }}>
              ...
              <span style={{ fontSize: 15, fontWeight: 700, color: '#FFFFFF', background: '#1B4DE6', border: '1.5px solid #1B4DE6', borderRadius: 8, padding: '10px 18px' }}>
                + anything else →
              </span>
            </div>
          </div>
          ...
          <div style={{ maxWidth: 1180, margin: '0 auto' }}>
            <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', flexWrap: 'wrap', gap: 24, marginBottom: 56 }}>
              <div style={{ maxWidth: 720 }}>
                <div style={{ fontSize: 12, fontWeight: 800, letterSpacing: '0.20em', textTransform: 'uppercase', color: '#F58A1F', marginBottom: 18 }}>API + Integrations</div>
              ...
              <div style={{ padding: '18px 24px', background: 'rgba(245,138,31,0.10)', border: '1px solid rgba(245,138,31,0.30)', borderRadius: 10, minWidth: 220 }}>
                ...
                <div style={{ fontSize: 36, fontWeight: 900, color: '#F58A1F', lineHeight: 1, letterSpacing: '-0.02em' }}>40+</div>
            ...
            <div style={{ marginTop: 32, padding: '22px 28px', background: 'rgba(27,77,230,0.08)', border: '1px solid rgba(27,77,230,0.25)', borderRadius: 12, display: 'flex', alignItems: 'center', gap: 18, flexWrap: 'wrap' }}>
              <div style={{ width: 42, height: 42, borderRadius: 8, background: 'rgba(27,77,230,0.18)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                <svg width="22" height="22" fill="none" stroke="#1B4DE6" strokeWidth="2.5" viewBox="0 0 24 24">
        ...
        {/* ── CTA ── */}
        <section className="hiw-section" style={{ background: '#1B4DE6', padding: '96px 40px', textAlign: 'center' }}>
          <div style={{ maxWidth: 700, margin: '0 auto' }}>
            <h2 className="hiw-cta-h2" style={{ fontSize: 64, fontWeight: 900, color: '#FFFFFF', lineHeight: 1.05, letterSpacing: '-0.03em', marginBottom: 20 }}>
              Let's get your<br />
              <span style={{ color: '#F58A1F' }}>time back.</span>
            </h2>
            ...
            <div style={{ display: 'flex', gap: 14, justifyContent: 'center', flexWrap: 'wrap' }}>
              <button onClick={() => router.push('/packages')} style={{ padding: '18px 44px', background: '#F58A1F', color: '#0B0D17', border: 'none', borderRadius: 10, fontSize: 15, fontWeight: 800, letterSpacing: '0.08em', textTransform: 'uppercase', cursor: 'pointer', fontFamily: 'inherit' }}>
                See Packages
              </button>
        ...
        <div className="hiw-footer" style={{ background: '#0F1120', padding: '24px 40px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
          <span style={{ fontSize: 13, color: 'var(--color-chart-text)', letterSpacing: '0.04em' }}>783 OS · 783 Partners</span>
          <a href="mailto:info@783capital.com" style={{ fontSize: 13, color: 'var(--color-chart-text)', textDecoration: 'none', letterSpacing: '0.04em' }}>info@783capital.com</a>
        </div>
      </div>
    </>
  );
