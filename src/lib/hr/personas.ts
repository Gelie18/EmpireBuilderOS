...
const JORDAN: Persona = {
  ...
  profile: {
    ...
    email: 'jordan.rivera@meritagepartners.com',
    phone: '(214) 555-0142',
...
const MARCUS: Persona = {
  ...
  profile: {
    ...
    email: 'marcus.chen@meritagepartners.com',
    phone: '(713) 555-0209',
  ...
  career: {
    ...
    learningInProgress: [
      { course: 'Lead Specialist Foundations (internal)', provider: 'Meritage Partners Learning', progress: 45 },
    ],
  },
  documents: [
...
const LEAH: Persona = {
  ...
  profile: {
    ...
    location: 'Dallas, TX',
    shift: 'Salaried · flex',
    email: 'leah.thompson@meritagepartners.com',
    phone: '(469) 555-0377',
